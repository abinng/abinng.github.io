...
const Bornforthis = {
  ...
  showWelcome: (ipStore) => {
    ...
    let dist = Bornforthis.getDistance(113, 35, ipStore.data.lng, ipStore.data.lat),
      address,
      welcome_info;
    //根据国家、省份、城市信息自定义欢迎语
    //海外地区不支持省份及城市信息
    ...
    🗺️您距离 <strong>abinng</strong> 约有 <strong>${dist}</strong> 公里！<br>
    当前IP地址为：
    <strong style="font-size:12px;"><span class="ip-address">${IP}</span></strong><br>
